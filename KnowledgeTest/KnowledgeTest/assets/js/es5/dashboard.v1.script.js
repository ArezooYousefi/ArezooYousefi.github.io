...
$(document).ready(function () {
    ...
    if (echartElemBar) {
        ...
        echartBar.setOption({
            ...
            series: [{
                name: 'Pass',
                data: [35, 69, 22, 60, 50, 50, 30, 80, 70, 60, 20, 30],
                ...
                name: 'Fail',
                data: [23, 35, 42, 25, 17, 15, 28, 32, 80, 20, 40, 35],
    ...
    if (echartElemPie) {
        ...
        echartPie.setOption({
            ...
            series: [{
                ...
                radius: '60%',
                center: ['50%', '50%'],
                data: [{ value: 25, name: 'Class 5-French' }, { value: 15, name: 'Class 5-English' }, { value: 55, name: 'Class 7-English' }, { value: 15, name: 'Class 7-French' }],
                itemStyle: {
                    emphasis: {
                        shadowBlur: 10,
                        shadowOffsetX: 0,
